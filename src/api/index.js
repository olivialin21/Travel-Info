...
const getAccessToken = async () => {
    ...
    try {
        ...
        const response = await axios.post('https://tdx.transportdata.tw/auth/realms/TDXConnect/protocol/openid-connect/token', new URLSearchParams({
...
export const searchCategary = async (category, filterQuery, perPage, skip, order = "") => {
    try {
...
export const searchCategaryDetail = async (category, id) => {
    try {
